...
//                    ),
    ...
    'controllers' => [
        'factories' => [
            ...
            Controller\ForumController::class => BaseFactory::class,
        ],
        'aliases' => [
            'index' => Controller\IndexController::class,
            'file' => Controller\FileController::class,
            'forum' => Controller\ForumController::class
        ]
    ...
    'view_manager' => [
        ...
        'template_map' => [
            ...
            'application/index/index' => __DIR__ . '/../view/application/index/index2.phtml',
