...
class Menu implements InputFilterAwareInterface
{
    ...
    /**
     * @ORM\Column(name="`options`", type="string", length=100, nullable=true)
     */
    protected $options;
    ...
    {
        $dataFields = array('id', 'parent_id', 'name', 'order_id', 'url', 'target', 'params', 'is_display', 'update_time', 'layout', 'memo', 'user_id', 'options');
    ...
    {
        return array('id', 'parent_id', 'name', 'order_id', 'url', 'target', 'params', 'is_display', 'update_time', 'layout', 'memo', 'user_id', 'options');
    }
}