 ...
 * @ORM\Table(name="semester_student", indexes={@ORM\Index(name="fk_semester_student_semester_class1_idx", columns={"semester_class_id"}), @ORM\Index(name="fk_semester_student_student1_idx", columns={"student_id"})})
 */
class SemesterStudent implements InputFilterAwareInterface
{
    ...
    {
        $dataFields = array('id', 'semester_class_id', 'number', 'student_id');
        $relationFields = array('semesterClass', 'student');
        $copiedFields = array();
    ...
    {
        return array('id', 'semester_class_id', 'number', 'student_id');
    }
}