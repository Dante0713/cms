 ...
 * @ORM\Table(name="semester_teacher", indexes={@ORM\Index(name="fk_semester_teacher_semester1_idx", columns={"semester_id"}), @ORM\Index(name="fk_semester_teacher_school1_idx", columns={"school_id"}), @ORM\Index(name="fk_teacher_idx", columns={"teacher_id"})})
 */
class SemesterTeacher implements InputFilterAwareInterface
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="School", inversedBy="semesterTeachers")
    ...
    {
        $dataFields = array('id', 'semester_id', 'teacher_id', 'school_id');
        $relationFields = array('semester', 'school', 'teacher');
        $copiedFields = array();
    ...
    {
        return array('id', 'semester_id', 'teacher_id', 'school_id');
    }
}