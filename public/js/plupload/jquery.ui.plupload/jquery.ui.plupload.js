...
@param {Object} settings For detailed information about each option check documentation.
	...
	@param {Boolean} [settings.multiple_queues=true] Re-activate the widget after each upload.twig procedure.
*/
...
/**
Dispatched when upload.twig is started.
...
/**
Dispatched when upload.twig is stopped.
...
/**
Dispatched during the upload.twig process.
...
/**
Dispatched when upload.twig of the whole queue is complete.
			...
			'<div class="ui-widget-content plupload_container">' +
				'<div class="ui-state-default ui-widget-header plupload_header">' +
					'<div class="plupload_header_content">' +
						...
						'<div class="plupload_header_text">' + _("Add files to the upload.twig queue and click the start button.") + '</div>' +
...
$.widget("ui.plupload", {
	...
	/**
	Start upload.twig. Triggers `start` event.
	...
	*/
	...
	/**
	Stop upload.twig. Triggers `stop` event.
