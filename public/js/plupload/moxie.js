	...
	function Runtime(options, type, caps, modeCaps, preferredMode) {
		...
		*/
		caps = Basic.extend({
			...
			slice_blob: false,
			// upload.twig file without preloading it to memory, stream it out directly from disk
			stream_upload: false,
			// programmatically trigger file browse dialog
			summon_file_dialog: false,
			// upload.twig file of specific size, size should be passed as argument
			...
			send: function(data, options) {
				...
				if (!_sync_flag) {
					...
					//if (!_upload_complete_flag) {
						// this.upload.twig.dispatchEvent('loadstart');	// will be dispatched either by native or runtime xhr
					//}
				}
			...
			*/
			...
			@example
				...
				img.onload = function() {
					...
					xhr.onload = function() {
						// upload.twig complete
					};
					xhr.open('post', 'upload.twig.php');
					xhr.send(formData);
				};
