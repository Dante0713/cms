...
if (elFinder && elFinder.prototype && typeof(elFinder.prototype.i18) == 'object') {
	elFinder.prototype.i18.el = {
		...
		messages   : {
			...
			'errUploadCommon'      : 'Πρόβλημα κατά το upload.twig.',
			'errUpload'            : 'Το αρχείο "$1" δεν μπόρεσε να γίνει upload.twig.',
			'errUploadNoFiles'     : 'Δεν βρέθηκαν αρχεία για upload.twig.',
