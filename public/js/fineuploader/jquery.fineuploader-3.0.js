...
qq.UploadButton = function(o){
    this._options = {
        ...
        hoverClass: 'qq-upload.twig-button-hover',
        focusClass: 'qq-upload.twig-button-focus'
    };
...
qq.FineUploaderBasic = function(o){
    ...
    this._options = {
        ...
        callbacks: {
            ...
            onValidate: function(fileData) {} // return false to prevent upload.twig
        },
        messages: {
            ...
            noFilesError: "No files to upload.twig.",
            onLeave: "The files are being uploaded, if you leave now the upload.twig will be cancelled."
        },
        retry: {
            enableAuto: false,
            maxAutoAttempts: 3,
...
qq.FineUploaderBasic.prototype = {
    ...
    _onBeforeManualRetry: function(id) {
        if (this._preventRetries[id]) {
            ...
            this.log("Retrying upload.twig for '" + fileName + "' (id: " + id + ")...");
            this._filesInProgress++;
            return true;
        }
        else {
...
/**
 * Class that creates upload.twig widget with drag-and-drop and file list
...
qq.FineUploader = function(o){
    ...
    qq.extend(this._options, {
        ...
        text: {
            ...
            dragZone: 'Drop files here to upload.twig',
            formatProgress: "{percent}% of {total_size}",
            waitingForResponse: "Processing..."
        },
        template: '<div class="qq-uploader">' +
            ((!this._options.dragAndDrop || !this._options.dragAndDrop.disableDefaultDropzone) ? '<div class="qq-upload.twig-drop-area"><span>{dragZoneText}</span></div>' : '') +
            (!this._options.button ? '<div class="qq-upload.twig-button"><div>{uploadButtonText}</div></div>' : '') +
            (!this._options.listElement ? '<ul class="qq-upload.twig-list"></ul>' : '') +
            '</div>',

        // template for one item in file list
        fileTemplate: '<li>' +
            '<div class="qq-progress-bar"></div>' +
            '<span class="qq-upload.twig-spinner"></span>' +
            '<span class="qq-upload.twig-finished"></span>' +
            '<span class="qq-upload.twig-file"></span>' +
            '<span class="qq-upload.twig-size"></span>' +
            '<a class="qq-upload.twig-cancel" href="#">{cancelButtonText}</a>' +
            '<a class="qq-upload.twig-retry" href="#">{retryButtonText}</a>' +
            '<span class="qq-upload.twig-status-text">{statusText}</span>' +
            '</li>',
        classes: {
            // used to get elements from templates
            button: 'qq-upload.twig-button',
            drop: 'qq-upload.twig-drop-area',
            dropActive: 'qq-upload.twig-drop-area-active',
            dropDisabled: 'qq-upload.twig-drop-area-disabled',
            list: 'qq-upload.twig-list',
            progressBar: 'qq-progress-bar',
            file: 'qq-upload.twig-file',
            spinner: 'qq-upload.twig-spinner',
            finished: 'qq-upload.twig-finished',
            retrying: 'qq-upload.twig-retrying',
            retryable: 'qq-upload.twig-retryable',
            size: 'qq-upload.twig-size',
            cancel: 'qq-upload.twig-cancel',
            retry: 'qq-upload.twig-retry',
            statusText: 'qq-upload.twig-status-text',

            // added to list item <li> when upload.twig completes
            // used in css to hide progress spinner
            success: 'qq-upload.twig-success',
            fail: 'qq-upload.twig-fail',
    ...
    // overwrite the upload.twig button text if any
...
qq.UploadHandlerAbstract.prototype = {
    ...
    /**
     * Cancels file upload.twig by id
     */
    cancel: function(id){
    ...
    reset: function() {
        this.log('Resetting upload.twig handler');
        this._queue = [];
        this._params = [];
    },
    /**
     * Actual upload.twig method
     */
    _upload: function(id){},
    /**
    ...
    _cancel: function(id){},
    /**
     * Removes element from queue, starts upload.twig of next
     */
...
qq.extend(qq.UploadHandlerForm.prototype, {
    add: function(fileInput){
        ...
        var id = 'qq-upload.twig-handler-iframe' + qq.getUniqueId();
    ...
    _upload: function(id, params){
        ...
        this.log('Sending upload.twig request for ' + id);
        form.submit();
        qq(form).remove();
        ...
        this._detach_load_events[iframe.id] = qq(iframe).attach('load', function(){
            ...
            try {
                ...
                if (iframe.contentDocument &&
                    ...
                    // when we upload.twig file with iframe
                    return;
                }
            }
            catch (error) {
                //IE may throw an "access is denied" error when attempting to access contentDocument on the iframe in some cases
                self.log('Error when attempting to access iframe during handling of upload.twig response (' + error + ")", 'error');
            }
    ...
    _getIframeContentJSON: function(iframe){
        ...
        try {
            ...
            this.log('Error when attempting to parse form upload.twig response (' + error + ")", 'error');
...
qq.extend(qq.UploadHandlerXhr.prototype, {
     ...
     * Returns id to use with upload.twig, cancel
     **/
    add: function(file){
